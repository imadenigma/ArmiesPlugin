        ...
        val ms = measureTimeMillis {
            ...
            if (Army.armies.none { it.name.equals("us army", true) }) {
                val safeZone = Army(
                        ...
                        mutableSetOf(),
                        true,
                        BlockPosition.of(config.getNode("safezone", "core").getString("").asLocation()).toBlock(),
                ...
                val warzone = Army(
                        ...
                        mutableSetOf(),
                        true,
                        config.getNode("warzone", "core").getString("").asLocation().block,
                        config.getNode("warzone", "core").getString("").asLocation(),
                        mutableSetOf(),
                        0.0,
                        250,
                        mutableSetOf(),
